...
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" name="compare_price" class="form-controller" step="0.01" min="0" value="{{ old('compare_price',$product->compare_price) }}"/>
    </div>
...
<div class="form-check">
    <input class="form-check-input" type="radio" name="status" id="exampleRadios2" @checked(old('status',$product->status) === "archived") value="archived">
    <label class="form-check-label" for="exampleRadios2">
       Archived
    </label>
</div>
<div class="form-check">
    <input class="form-check-input" type="radio" name="status" id="exampleRadios3" @checked(old('status',$product->status) === "draft") value="draft">
